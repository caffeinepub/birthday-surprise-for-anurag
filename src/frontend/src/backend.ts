...
export class Backend implements backendInterface {
    ...
    async completeLevel(arg0: string, arg1: bigint): Promise<void> {
    ...
    async getAllPlayerEntries(): Promise<Array<PlayerEntry>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllPlayerEntries();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getProfile(arg0: string): Promise<PlayerEntry> {
        if (this.processError) {
            try {
