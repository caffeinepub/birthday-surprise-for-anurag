...
function FinalScreen({ onReplay }) {
  ...
  const [letterOpen, setLetterOpen] = reactExports.useState(false);
  const [envelopeHovered, setEnvelopeHovered] = reactExports.useState(false);
  reactExports.useEffect(() => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative min-h-screen flex flex-col items-center justify-center px-4 py-8 animate-screen", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 flex flex-col items-center w-full max-w-md", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-2 animate-fade-in-up", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-4xl mb-3", children: "🎉🎂🎊" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "text-4xl sm:text-5xl font-black leading-tight mb-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "glitter-rose", children: "Happy Birthday, " }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "glitter-gold", children: "Anurag!" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "p",
          {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative flex flex-col items-center w-full mt-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "p",
          {
            className: "text-sm font-semibold mb-3 animate-bounce-gentle",
            style: { color: "oklch(0.52 0.15 10)" },
            children: "✉️ Tap the envelope to open your letter"
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            ...
            style: {
              ...
              transform: envelopeHovered ? "scale(1.04) translateY(-4px)" : "scale(1)",
              filter: envelopeHovered ? "drop-shadow(0 12px 28px oklch(0.58 0.2 10 / 0.35))" : "drop-shadow(0 6px 16px oklch(0.58 0.2 10 / 0.18))"
            },
            children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "svg",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("title", { children: "Birthday envelope" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "rect",
                    {
                      x: "2",
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "polygon",
                    {
                      ...
                      fill: envelopeHovered ? "oklch(0.96 0.06 65)" : "oklch(0.82 0.1 65)",
                      stroke: "oklch(0.72 0.14 65)",
                      strokeWidth: "2",
    ...
    letterOpen && /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            style: {
              ...
              boxShadow: "0 8px 40px rgba(60,30,10,0.45), inset 0 0 60px rgba(160,100,20,0.08)",
              animation: "letterSlideUp 0.5s cubic-bezier(0.22, 1, 0.36, 1) both",
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                ...
                {
                  style: {
                    background: "repeating-linear-gradient(transparent, transparent 31px, rgba(139,109,56,0.18) 31px, rgba(139,109,56,0.18) 32px)",
                    position: "absolute",
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "p",
                      {
                        ...
                        children: "Happy Birthday, Anurag ❤️"
                      }
                    ),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: { marginBottom: "1rem" }, children: `It still feels a little unreal that I met you on my birthday… and now I'm writing this for yours. Life really said "plot twist" and honestly, I'm very glad it did!` }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: { marginBottom: "1rem" }, children: "In just five or six months, we've somehow lived so many versions of us. Long-distance calls, you going to the US, everyday conversations, random jokes… and of course our iconic Kasol trip. Matlab trip ka plan kuch aur tha, reality kuch aur hi nikal aayi (🤒) But I think that told us a lot about each other. You taking care of me so patiently, and me proving that I can sleep at levels that are… not humanly normal 😂" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: { marginBottom: "1rem" }, children: "I really love how kind and caring you are. The way you show up, the way you make things feel easy, and how safe I feel with you." }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: { marginBottom: "1rem" }, children: "What I love about us is how we're similar where it matters, and different where it keeps things interesting. It just fits. I know things are moving a little fast, and talking about the future still makes us a bit awkward and giggly… but somewhere it feels right. I hope it feels the same for you too." }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: { marginBottom: "1rem" }, children: "I'm really grateful for you. For the comfort, the conversations, the laughter, and even our awkward moments. I like talking to you every day. I like having you in my life. And I'm really fond of you… as a person and as mine ❤️" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: { marginBottom: "1rem" }, children: "Wishing you all the success, wealth, happiness, and good health as you turn 29. You deserve the best of everything." }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: { marginBottom: "1.5rem" }, children: "And selfishly… I hope I get to be a part of all of it 😌💛" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { style: { fontStyle: "italic", color: "#6b3a2a" }, children: [
                      "With love,",
...
function FloatingHearts() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fixed inset-0 pointer-events-none z-0 overflow-hidden", children: hearts.map((heart) => /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
...
function IntroScreen({ onStart }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 flex flex-col items-center justify-center min-h-screen px-6 py-12 animate-screen", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center max-w-md relative z-10", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-5xl mb-6 animate-bounce-gentle", children: "🎂🎉🎈" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "h1",
        {
          className: "text-3xl sm:text-4xl font-black mb-4 leading-tight",
          style: { color: "oklch(0.42 0.18 10)" },
          children: "A Very Serious Birthday Game 🧐"
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "p",
        {
          ...
          children: "Highly important tasks ahead."
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "p",
        {
          ...
          children: "Failure is not an option (it is, but still) 😌"
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "p",
              {
                ...
                children: "3 fun levels await you:"
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-around text-center", children: [
              { icon: "🎈", name: "Pop Balloons" },
              { icon: "🎡", name: "Spin Wheel" },
              { icon: "💖", name: "Memory Match" }
            ].map((l) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center gap-1", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-2xl", children: l.icon }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "span",
                {
...
function Level1Balloons({ onComplete }) {
  const initialBalloons = reactExports.useMemo(() => {
  ...
  const [balloons, setBalloons] = reactExports.useState(initialBalloons);
  const [poppingId, setPoppingId] = reactExports.useState(null);
  ...
  const popBalloon = reactExports.useCallback(
    (id, message) => {
      ...
      setTimeout(() => {
        setBalloons(
          (prev) => prev.map((b) => b.id === id ? { ...b, popped: true } : b)
        );
        setPoppingId(null);
        setBalloons((prev) => {
  ...
  const dismissMessage = reactExports.useCallback(() => {
    setActiveMessage(null);
  }, []);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 flex flex-col animate-screen", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center pt-4 pb-2 px-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "h2",
        {
          className: "text-2xl sm:text-3xl font-black",
          style: { color: "oklch(0.42 0.18 10)" },
          children: "🎈 Pop the Balloons!"
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "p",
        {
          ...
          style: { color: "oklch(0.6 0.06 20)" },
          children: "Click each balloon to reveal a secret message"
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          ...
          children: remainingCount > 0 ? `${remainingCount} balloons left 🎈` : "All popped! 🎉"
        }
      )
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative flex-1", style: { minHeight: "60vh" }, children: balloons.map((balloon) => {
      ...
      return /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          ...
          onClick: () => !balloon.popped && popBalloon(balloon.id, balloon.message),
          disabled: balloon.popped,
          "data-ocid": `balloon.item.${balloon.id + 1}`,
          children: !balloon.popped && /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              style: {
                animation: isPopping ? "popBalloon 0.4s ease-out forwards" : `balloonFloat ${balloon.animDuration} ease-in-out infinite`,
    ...
    activeMessage && /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        className: "fixed inset-0 z-50 flex items-center justify-center p-4",
        style: { background: "rgba(0,0,0,0.3)", backdropFilter: "blur(4px)" },
        "data-ocid": "balloon.modal",
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "card-game p-6 max-w-xs w-full text-center animate-fade-in-up", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-4xl mb-3", children: "💌" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "p",
            {
    ...
    completed && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-6 text-center animate-fade-in-up", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-4xl mb-3", children: "🎊" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "p",
        {
...
function Level2SpinWheel({ onComplete }) {
  const canvasRef = reactExports.useRef(null);
  const [spinning, setSpinning] = reactExports.useState(false);
  const [result, setResult] = reactExports.useState(null);
  const [_spinCount, setSpinCount] = reactExports.useState(0);
  const [completed, setCompleted] = reactExports.useState(false);
  const animRef = reactExports.useRef(0);
  const currentRotRef = reactExports.useRef(0);
  const drawWheel = reactExports.useCallback((rot) => {
    const canvas = canvasRef.current;
    if (!canvas) return;
    const ctx = canvas.getContext("2d");
    if (!ctx) return;
  ...
  const spin = reactExports.useCallback(() => {
    ...
    const animate = (now2) => {
      ...
      if (progress < 1) {
        ...
        const segAngle = Math.PI * 2 / SEGMENTS.length;
        const normalised = (current % (Math.PI * 2) + Math.PI * 2) % (Math.PI * 2);
        const pointerAngle = Math.PI * 1.5;
        const adjusted = (pointerAngle - normalised + Math.PI * 2) % (Math.PI * 2);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 flex flex-col items-center animate-screen px-4 py-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "h2",
      {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "p",
      {
        ...
        style: { color: "oklch(0.6 0.06 20)" },
        children: "Spin once to unlock the next level"
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
    ...
    completed && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-4 text-center animate-fade-in-up", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "p",
        {
          className: "text-xl font-black mb-3",
          style: { color: "oklch(0.42 0.18 10)" },
          children: "🎊 You've spun the wheel!"
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
...
function Level3Memory({ onComplete }) {
  const [cards, setCards] = reactExports.useState(createCards);
  const [flippedIds, setFlippedIds] = reactExports.useState([]);
      ...
      if (newFlipped.length === 2) {
        ...
        setTimeout(() => {
          if (isMatch) {
            ...
            setCards(
              (prev) => prev.map(
                (c) => c.id === id1 || c.id === id2 ? { ...c, matched: true } : c
              )
            );
            setMatchCount((prev) => {
              const next = prev + 1;
            ...
            setCards(
              (prev) => prev.map(
                (c) => c.id === id1 || c.id === id2 ? { ...c, flipped: false } : c
              )
            );
          }
          setFlippedIds([]);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 flex flex-col items-center animate-screen px-3 py-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "h2",
      {
        className: "text-2xl sm:text-3xl font-black mb-1",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        ...
        children: cards.map((card, idx) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            type: "button",
            className: `card-flip-container ${card.flipped || card.matched ? "flipped" : ""}`,
            style: { height: "clamp(60px, 18vw, 80px)" },
            onClick: () => flipCard(card.id),
            "data-ocid": `memory.item.${idx + 1}`,
            children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "card-flip-inner", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "card-face card-back", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { fontSize: "clamp(1.2rem, 4vw, 1.6rem)" }, children: "💗" }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  className: `card-face card-front ${card.matched ? "animate-match-glow" : ""}`,
                  style: {
                    background: card.matched ? "oklch(0.95 0.06 140)" : "white"
                  },
                  children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { fontSize: "clamp(1.4rem, 5vw, 1.8rem)" }, children: card.emoji })
                }
              )
            ] })
          },
    ...
    completed && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-6 text-center animate-fade-in-up", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-4xl mb-3", children: "🎊✨💖" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "p",
        {
...
function ProgressStepper({ currentStep }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-center gap-1 sm:gap-2 py-2 max-w-sm mx-auto", children: STEPS.map((step, idx) => {
    const stepNum = idx + 1;
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          className: `flex flex-col items-center gap-0.5 transition-all duration-300 ${isActive ? "scale-110" : ""}`,
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                className: `w-9 h-9 sm:w-10 sm:h-10 rounded-full border-2 flex items-center justify-center text-sm font-bold transition-all duration-300 ${isComplete ? "step-complete" : isActive ? "step-active shadow-lg" : "step-pending"}`,
                children: isComplete ? "✓" : step.icon
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "span",
              {
                ...
                style: {
                  color: isActive ? "oklch(0.58 0.2 10)" : isComplete ? "oklch(0.45 0.18 140)" : "oklch(0.6 0.04 20)"
                },
                children: step.label
              }
            )
      ...
      idx < STEPS.length - 1 && /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          ...
          style: {
            background: stepNum < currentStep ? "oklch(0.65 0.18 140)" : "oklch(0.88 0.05 350)"
          }
        }
      )
    ] }, step.label);
...
function playSpinSound(duration = 2) {
  try {
    const ctx = new (window.AudioContext || window.webkitAudioContext)();
    const osc = ctx.createOscillator();
    const gain = ctx.createGain();
...
function App() {
  ...
  const navigateTo = reactExports.useCallback((next) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      style: {
        background: "linear-gradient(160deg, oklch(0.98 0.012 60) 0%, oklch(0.96 0.02 350) 50%, oklch(0.97 0.015 20) 100%)"
      },
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              screen !== "intro" && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-4 pt-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ProgressStepper, { currentStep }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 flex flex-col", children: [
                screen === "intro" && /* @__PURE__ */ jsxRuntimeExports.jsx(IntroScreen, { onStart: () => navigateTo("level1") }),
                screen === "level1" && /* @__PURE__ */ jsxRuntimeExports.jsx(Level1Balloons, { onComplete: () => navigateTo("level2") }),
                screen === "level2" && /* @__PURE__ */ jsxRuntimeExports.jsx(Level2SpinWheel, { onComplete: () => navigateTo("level3") }),
                screen === "level3" && /* @__PURE__ */ jsxRuntimeExports.jsx(Level3Memory, { onComplete: () => navigateTo("final") }),
                screen === "final" && /* @__PURE__ */ jsxRuntimeExports.jsx(FinalScreen, { onReplay: () => navigateTo("intro") })
              ] })
            ]
          }
        )
...
Service({
  "completeLevel": Func([Text, Nat], [], []),
  "createProfile": Func([Text], [], []),
  "getAllPlayerEntries": Func([], [Vec(PlayerEntry)], ["query"]),
  "getProfile": Func([Text], [PlayerEntry], ["query"])
});
